    ...
    <header className="bg-gray-800 text-white p-4">
      <div className="max-w-screen-xl mx-auto flex justify-between items-center">
        ...
        <nav className="space-x-4">
          <Link to="/" className="hover:text-blue-300">Kezdőlap</Link>
          <Link to="/about" className="hover:text-blue-300">Rólunk</Link>
          <Link to="/contact" className="hover:text-blue-300">Kapcsolat</Link>
          <Link to="/products" className="hover:text-blue-300">Jelmezeink</Link>
